...
! function(e) { "use strict";
    e.sessionTimeout = function(t) {
        function o() { f || (e.ajax({ type: d.ajaxType, url: d.keepAliveUrl, data: d.ajaxData }), f = !0,
            setTimeout(function() { f = !1 }, d.keepAliveInterval)) }

        function i() { clearTimeout(a), (d.countdownMessage || d.countdownBar) && s("upgrade", !0), "function" == typeof d.onStart && d.onStart(d), d.keepAlive && o(),
            a = setTimeout(function() { "function" != typeof d.onWarn ? e("#session-timeout-dialog").modal("show") : d.onWarn(d), n() }, d.warnAfter) }
        ...
        var a, r = { title: "Your Session is About to Expire!", message: "Your session is about to expire.", logoutButton: "Upgrade TO Pro", keepAliveButton: "Maybe Later", keepAliveUrl: "/new-able/default/session-timeout.html", ajaxType: "POST", ajaxData: "", redirUrl: "/timed-out", logoutUrl: "/log-out", warnAfter: 9e5, redirAfter: 12e5, keepAliveInterval: 5e3, keepAlive: !0, ignoreUserActivity: !1, onStart: !1, onWarn: !1, onRedir: !1, countdownMessage: !1, countdownBar: !1, countdownSmart: !1 },
            d = r,
            l = {};
