                                ...
                                <form method="POST" action="{{{ URL::to('stocks') }}}" accept-charset="UTF-8"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="right-inner-addon ">
                                            ...
                                            <input class="form-control datepicker" readonly="readonly" placeholder=""
                                                   type="text" name="date" id="date" value="{{date('Y-m-d')}}" required>
                                        </div>
                                    </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required class="form-control" data-parsley-type="number"
                                                   data-parsley-trigger="change focusout" name="lease_qty"
                                        ...
                                        <div class="form-actions form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-sm">Receive/Generate Code
                                            </button>
                                        </div>
