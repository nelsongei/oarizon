                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <form method="POST" action="{{{url('Appraisals/update/'.$appraisal->id) }}}" >@csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input class="form-control" readonly placeholder="" type="text" name="maxscore" id="maxscore" value="{{App\models\Appraisalquestion::getScore($appraisal->appraisalquestion_id)}}">
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
