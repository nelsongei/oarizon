                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{{ URL::to('nssf/update/'.$nrate->id) }}}"
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <label for="username">Employee Amount<span
                                                        style="color:red">*</span></label>
                                                <input class="form-control" placeholder="" type="text"
                                                       name="employee_amount"
                                                       id="employee_amount" value="{{ $nrate->ss_amount_employee}}">
                                            </div>

                                            <div class="form-group">
                                                <label for="username">Employer Amount <span
                                                        style="color:red">*</span></label>
                                                <input class="form-control" placeholder="" type="text"
                                                       name="employer_amount"
                                                       id="employer_amount" value="{{ $nrate->ss_amount_employer}}">
                                            </div>
