                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <form method="POST" action="{{{ url('other_earnings') }}}" >@csrf
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="earning" id="earning" class="form-control" required>
                                                    <option></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="" type="text" name="narrative" id="narrative" value="{{{ old('narrative') }}}" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="username">Formular <span style="color:red">*</span></label>
                                                <select name="formular" id="formular" class="form-control forml" required>
                                                    <option></option>
                                            ...
                                            <div class="form-group insts" id="insts">
                                                ...
                                                <input class="form-control" placeholder="" required onkeypress="totalB(),getdate()" onkeyup="totalB(),getdate()" type="text" name="instalments" id="instalments" value="{{{ old('instalments') }}}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" placeholder="" type="text" required  onkeypress="totalBalance()" onkeyup="totalBalance()" name="amount" id="amount" value="{{{ old('amount') }}}">
                                                </div>
                                                <script type="text/javascript">
                                                    $(document).ready(function() {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="right-inner-addon ">
                                                    ...
                                                    <input class="form-control earningdate" readonly="readonly" placeholder="" type="text" name="ddate" id="ddate" value="{{{ old('ddate') }}}">
                                                </div>
                                            </div>
