                                    ...
                                    <form method="POST" action="{{{ URL::to('other_earnings') }}}" accept-charset="UTF-8">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="" type="text" name="narrative" id="narrative"
                                                       value="{{{ old('narrative') }}}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="right-inner-addon ">
                                                    ...
                                                    <input class="form-control earningdate" readonly="readonly" placeholder="" type="text"
