                            ...
                            <div class="col-lg-5">
                                ...
                                <form method="POST" action="{{{ URL::to('erporders/create') }}}" accept-charset="UTF-8">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <label for="credit_ac">Credit Account <span style="color:red">*</span>
                                                :</label>
                                        ...
                                        <div class="form-group">
                                            <label for="debit_ac">Debit Account <span style="color:red">*</span>
                                                :</label>
                                        ...
                                        <div class="form-group">
                                            <label for="debit_ac">Transaction Desription <span
