...
<div class="content" style='margin-top:-50px;'>
    <table>
        <tr>
            <td width="80"><strong>Employer:</strong></td>
            <td>{{ strtoupper($organization->name)}}</td>
        </tr>
        <tr>
            <td width="80"><strong>Employee Code:</strong></td>
            <td width="80">{{$organization->nhif_no}}</td>
        </tr>
        {{'<tr><td width="80"><strong>Period</strong> : </td><td>'.$period.'</td></tr>'}}
        <tr>
            <td width="80"><strong>Due Date: </strong></td>
            <td>
                <?php
                $due = 0;
                $year = 0;
    ...
    <div align="center"><strong>NHIF RETURNS</strong></div>
    <br>
