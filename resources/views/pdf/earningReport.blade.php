...
<div class="footer">
    ...
    @if($type == 'All')
   <div style="margin-bottom:20px">{{'<strong>Period</strong> : '.$period}}<div align="center"><strong>Earning Report</strong></div></div>
    @else
    <div style="margin-bottom:20px">{{'<strong>Period</strong> : '.$period}}<div align="center"><strong>Earning Report for {{$type}}</strong></div></div>
    @endif
