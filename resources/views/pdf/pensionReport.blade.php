...
<!--<div class="footer">
  ...
  <hr>
    ...
    @if($type == 'All')
   <div style="margin-bottom:20px"><strong>Period</strong> : {{$period}}<div align="center"><strong>Pension Contributions Report</strong></div></div>
    @else
    <div style="margin-bottom:20px"><strong>Period</strong> : {{$period}}<div align="center"><strong>Pension Contributions Report for {{$employee->personal_file_number.' : '.$employee->first_name.' '.$employee->last_name}}</strong></div></div>
    @endif
