...
<div class="row">
	<form class="form-inline" method="POST" id="addItem" action="{{{URL::to('erpquotations/edit2/add')}}}">
		<div class="col-lg-12">
...
<div class="row">
	<div class="col-lg-12">
		<form role="form" action="{{{URL::to('erpquotations/edit2/'.$order->id)}}}" method="POST">
				...
				<tbody>
					...
					@foreach($order->erporderitems as $orderitem)
						...
						<tr>
							...
							<td>
								<div class="btn-group">
                  	<a href="{{URL::to('erpquotations/delete2/'.$order->id.'/'.$orderitem->id)}}" class="btn btn-danger btn-sm" onclick="return (confirm('Are you sure you want to remove this item?'))"> Remove </a>
                </div>
							</td>
						</tr>
			...
			<table border="0" align="right" style="width:400px; box-shadow:none" class="tb-none">
              ...
              <td>{{$tax->name}}</td>
              @if(count(App\Models\TaxOrder::getAmount($tax->id,$order->order_number)) > 0)
