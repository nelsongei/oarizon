...
<div class="row">
    ...
    <h4><font color='green'>Invoice Number : {{$order->order_number}} &emsp;| &emsp;Client: {{$order->client->name}}  &emsp; |&emsp; Date: {{$order->date}} &emsp; |&emsp; Status: {{$order->status}} </font> </h4>
<hr>
</div>
</div>
...
<div id="myModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Mail Invoice To Client</h4>
            </div>
            <div class="modal-body">
                <form role="form" action="{{URL::to('erpquotations/mailinvoice')}}" method="POST">
                    <!-- HIDDEN FIELDS -->
                    <input type="hidden" name="order_id" value="{{$order->id}}">
                    ...
                    <div class="form-group">
                        <label>Subject:</label>
                        <input class="form-control" type="text" name="subject" value="Invoice">
                    </div>
                    <div class="form-group">
                        <label>Email:</label>
...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <a href="{{URL::to('erpReports/product/'.$order->id)}}" class="lnk btn btn-primary btn-sm edit_lnk">
            <span class="glyphicon glyphicon-file"></span>&nbsp; Product Report
        </a>&emsp;
     ...
     @endif
        ...
        <a href="{{URL::to('erpquotations/edit2/'.$order->id)}}" class="lnk btn btn-primary btn-sm edit_lnk">
            <span class="glyphicon glyphicon-pencil"></span>&nbsp; Edit Invoice
        </a>&emsp;

        <a href="#myModal" role="button" class="lnk btn btn-primary btn-sm mail_lnk" data-toggle="modal">
            <span class="glyphicon glyphicon-envelope"></span>&nbsp; Mail Invoice
        </a>&nbsp;
        <!-- <a href="{{URL::to('erpReports/invoice/'.$order->id)}}" role="button" class="lnk btn btn-primary btn-sm mail_lnk">
