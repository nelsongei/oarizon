...
<div class="row">
  ...
  <form class="form-inline" method="post" action="{{URL::to('quotationitems/create2')}}">
    ...
    <tbody>
        ...
        <!-- <tr> -->
            ...
            <td>{{asMoney($amount)}}</td>
             ...
             <td>
                <div class="btn-group">
                  <a href="{{URL::to('quotationitems/edit2/'.$count)}}" class="btn btn-success btn-sm"> Edit </a>
                </div>&emsp;
                <div class="btn-group">
                  <a href="{{URL::to('quotationitems/remove2/'.$count)}}" class="btn btn-danger btn-sm"> Delete </a>
                </div>
            </td>
        </tr>
...
<form method="post" action="{{URL::to('erpquotation/commit4')}}">
