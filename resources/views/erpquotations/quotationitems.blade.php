...
<?php
  ...
  $orderDets = Session::get('erporder');
  if($orderDets['type']=='product'){$theItems=$items;}else if($orderDets['type']=='service'){
    $theItems=$servall;}else{$theItems=$allItems;}
 ?>
<div class="row">
	<div class="col-lg-12">
  <h4><font color='green'>Quotation Number : {{Session::get('erporder')['order_number']}} &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Client: {{Session::get('erporder')['client']['name']}}  &nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp;&nbsp; Date: {{Session::get('erporder')['date']}} </font></h4>
  ...
  <form class="form-inline" method="post" action="{{URL::to('quotationitems/create')}}">
      ...
      <div class="col-lg-12">
        ...
        <div class="form-group "style='width:45%;' >
            ...
            <select name="item" id="item" class="form-control" style='width:100%; border-radius:5px;' required>
            <option></option>
        ...
        <div class="form-group " id="qt" style='width:45%;'>
            ...
            <input type="text" name="quantity" id="quantity" class="form-control" style='width:100%;' required>
        </div>&nbsp;&nbsp;
