								...
								<div class="card-body">
									    <div class="card-header">
											<ul class="nav nav-pills">
												...
												<li class="nav-item"><a class="nav-link" href="#returnInwards" data-toggle="tab">Return Inwards</a></li>
											</ul>
										</div>
													...
													<div class="card">
														<div class="card-header">
															<div class="card-header-right">
																<a class="dt-button btn-sm" href="{{ url('clients/create')}}">New Client</a>
															</div>
