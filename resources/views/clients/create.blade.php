...
@section('xara_cbs')
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <input class="form-control" placeholder="" data-parsley-trigger="change focusout" data-parsley-type="number" minlenght="10" type="text" name="office_phone" id="office_phone" value="{{{ Request::old('office_phone') }}}" required>
        </div>
      ...
      <!--  <div class="form-group">
            ...
            <label class="username" for="exampleCheck1" value="Customer">Customer</label>
        </div> -->
