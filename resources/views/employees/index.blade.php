                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li><a href="{{url('employees/view/'.$employee->id)}}">View</a>
                                                        </li>
                                                        ...
                                                        <li><a href="{{url('employees/deactivate/'.$employee->id)}}"
                                                ...
                                                <center>
                                                    <div class="flex flex-col items-center justify-center mt-16"
                                                        ...
                                                        <div class="flex flex-col items-center justify-center">
                                                            <svg width="125" height="110" viewBox="0 0 125 110"
                                                                 fill="#5851d8"
                                                                ...
                                                                <defs>
                                                                    <clipPath id="clip0">
                                                                        <rect width="124.808" height="110"
                                                                              fill="white"></rect>
                                                                    </clipPath>
                                                                </defs>
                                                            </svg>
                                                        </div>
                                                        <div class="mt-2"><label class="font-medium">No Employees
                                                                yet!</label></div>
                                                        <div class="mt-2"><label class="text-gray-500">This section will
