                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-2">
                                            ...
                                            <br>
                                            <img
                                                src="{{asset('/public/uploads/employees/signature/'.$employee->signature) }}"
                                                width="120px"
                                                height="50px" alt="">
                                        </div>
                                        <div class="col-lg-5">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                <tr>
                                                    <td colspan="2"><strong><span style="color:green">Personal Information</span></strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div role="tabpanel">
                                                ...
                                                <ul class="nav nav-tabs" role="tablist">
                                                    <li role="presentation" class="active"><a href="#employeeinfo"
                                                                                              aria-controls="employeeinfo"
                                                                                              role="tab"
                                                                                              data-toggle="tab">Employee
                                                            Information</a></li>
                                                    <li role="presentation"><a href="#kins" aria-controls="kins"
                                                                               role="tab" data-toggle="tab">Next of
                                                            Kin</a></li>
                                                    <li role="presentation"><a href="#documents"
                                                                               aria-controls="documents" role="tab"
                                                                               data-toggle="tab">Documents</a>
                                                    </li>
                                                    <li role="presentation"><a href="#appraisals"
                                                                               aria-controls="appraisals" role="tab"
                                                                               data-toggle="tab">Appraisal</a></li>
                                                    <li role="presentation"><a href="#properties"
                                                                               aria-controls="properties" role="tab"
                                                                               data-toggle="tab">Company Property</a>
                                                    </li>
                                                    <li role="presentation"><a href="#occurences"
                                                                               aria-controls="occurences" role="tab"
                                                                               data-toggle="tab">Occurence</a></li>
                                                    <li role="presentation"><a href="#benefits" aria-controls="benefits"
                                                                               role="tab" data-toggle="tab">Benefits</a>
                                                    </li>
                                                </ul>
