                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <div id="dialog-form" style="display: none" title="Create new education level">
                                    ...
                                    <div id="dialog-form" style="display: none" title="Create new bank">
                                    ...
                                    <div id="dialog-form" style="display: none" title="Create new bank branch">
                                    ...
                                    <div id="dialog-form" style="display: none" title="Create new branch">
                                    ...
                                    <div id="dialog-form" style="display: none" title="Create new department">
                                    ...
                                    <div id="dialog-form" style="display: none" title="Create new job group">
                                    ...
                                    <div id="dialog-form" style="display: none" title="Create new employee type">
                                    ...
                                    <div id="dialog-form" title="Create new job title" style="display: none"
                                         class="mb-5 mb-lg-2">
                                    ...
                                    <form method="POST" action="{{{ url('employees/update/'.$employee->id) }}}"
                                          enctype="multipart/form-data" data-parsley-validate>@csrf

                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h3>Update Employee
                                                    <button style="margin-left:620px" type="submit"
                                                            class="btn btn-primary btn-sm">Update Employee
                                                    </button>
                                                </h3>
                                                    ...
                                                    <table class="table table-striped table-bordered" id="docEmp">
                                                        ...
                                                        @else
                                                            ...
                                                            @foreach($docs as $doc)
                                                                ...
                                                                ?>
                                                                <input class="docdata" type="hidden"
                                                                       name="curpath[{{$j-1}}]" id="curpath"
                                                                       value="{{$doc->document_path}}">
                                                                <tr>
                                                                    <td><input type='checkbox' class='dcase'/></td>
                                                                    <td><span id='dsnum'>{{$j}}.</span></td>
                                                                    <td id="f"><input class="docdata" type="file"
                                                                                      name="path[{{$j-1}}]" id="path"
                                                                                      value="{{$doc->document_path}}">
                                                                    </td>
                                                                    <td><input class="docdata" type='text' id='doc_name'
                                                                               name='doc_name[{{$j-1}}]'
                                                                               value="{{$file_name}}"/></td>
                                                                    <td><textarea class="docdata" style="width:150px"
                                                                                  name="description[{{$j-1}}]"
                                                                                  id="description">{{$doc->description}}</textarea>
                                                                    </td>
                                                                    <td>
                                                                        <div class="right-inner-addon">
                                                                            <i class="glyphicon glyphicon-calendar"></i>
