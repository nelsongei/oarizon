                            ...
                            <div class="card card-border-inverse">
                                <div class="card-header">
                                    <ul class="nav nav-pills">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="#items_category"
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-header">
                                                    ...
                                                    <div class="card-header-right">
                                                        <a class="dt-button btn-sm" href="{{ url('items/create')}}">New
                                                            Item</a>
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <ul class="dropdown-menu" role="menu">
                                                                                <li>
                                                                                    <a href="{{URL::to('items/edit/'.$item->id)}}">Update</a>
                                                                                </li>

                                                                                <li>
                                                                                    <a href="{{URL::to('items/delete/'.$item->id)}}"
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-header-right">
                                                            <a class="dt-button btn-sm"
                                                               href="{{ url('itemscategory/create')}}">New Category</a>
                                                        </div>
                                                    </div>
...
{{--                                                                                <ul class="dropdown-menu" role="menu">--}}
{{--                                                                                    <li>--}}
{{--                                                                                        <a href="{{URL::to('items/edit/'.$cat->id)}}">Update</a>--}}
{{--                                                                                    </li>--}}

{{--                                                                                    <li>--}}
{{--                                                                                        <a href="{{URL::to('items/delete/'.$cat->id)}}"--}}
{{--                                                                                           onclick="return (confirm('Are you sure you want to delete this item?'))">Delete</a>--}}
{{--                                                                                    </li>--}}
