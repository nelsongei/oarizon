                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="deduction" id="deduction" class="form-control">
                                                    ...
                                                    @foreach($deductions as $deduction)
                                                        <option
                                                            value="{{ $deduction->id }}"<?= ($ded->deduction_id == $deduction->id) ? 'selected="selected"' : ''; ?>> {{ $deduction->deduction_name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="formular" id="formular" class="form-control forml">
                                                    <option></option>
                                                    <option value="One Time"<?= ($ded->formular == 'One Time') ? 'selected="selected"' : ''; ?>>
                                                        One Time
                                                    </option>
                                                    <option
                                                        value="Recurring"<?= ($ded->formular == 'Recurring') ? 'selected="selected"' : ''; ?>>
                                                        Recurring
                                                    </option>
                                                    <option id="instals"
                                                            value="Instalments"<?= ($ded->formular == 'Instalments') ? 'selected="selected"' : ''; ?>>
                                                        Instalments
                                                    </option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="right-inner-addon ">
                                                    ...
                                                    <input class="form-control expiry" readonly="readonly" placeholder="" type="text"
                                                           name="ddate" id="ddate" value="{{ $ded->deduction_date }}">
                                                </div>
                                            </div>
